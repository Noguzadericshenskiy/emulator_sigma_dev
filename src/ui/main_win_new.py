...
################################################################################
## Form generated from reading UI file 'main_win_v7.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.modbus_dev_tab = QWidget()
        self.modbus_dev_tab.setObjectName(u"modbus_dev_tab")
        self.devices_tableWidget = QTableWidget(self.modbus_dev_tab)
        self.devices_tableWidget.setObjectName(u"devices_tableWidget")
        self.devices_tableWidget.setGeometry(QRect(0, 140, 1261, 631))
        self.chenge_state_device_groupBox = QGroupBox(self.modbus_dev_tab)
        self.chenge_state_device_groupBox.setObjectName(u"chenge_state_device_groupBox")
        self.chenge_state_device_groupBox.setGeometry(QRect(10, 0, 489, 131))
        self.verticalLayoutWidget = QWidget(self.chenge_state_device_groupBox)
        self.verticalLayoutWidget.setObjectName(u"verticalLayoutWidget")
        self.verticalLayoutWidget.setGeometry(QRect(10, 20, 471, 101))
        self.v_layer_state_dev_layout = QVBoxLayout(self.verticalLayoutWidget)
        self.v_layer_state_dev_layout.setObjectName(u"v_layer_state_dev_layout")
        self.v_layer_state_dev_layout.setContentsMargins(0, 0, 0, 0)
        self.h_top_layer_state_dev_layout = QHBoxLayout()
        self.h_top_layer_state_dev_layout.setObjectName(u"h_top_layer_state_dev_layout")

        self.v_layer_state_dev_layout.addLayout(self.h_top_layer_state_dev_layout)

        self.h_center_layer_state_dev_layout = QHBoxLayout()
        self.h_center_layer_state_dev_layout.setObjectName(u"h_center_layer_state_dev_layout")

        self.v_layer_state_dev_layout.addLayout(self.h_center_layer_state_dev_layout)

        self.h_bottom_layer_state_dev_layout = QHBoxLayout()
        self.h_bottom_layer_state_dev_layout.setObjectName(u"h_bottom_layer_state_dev_layout")

        self.v_layer_state_dev_layout.addLayout(self.h_bottom_layer_state_dev_layout)

        self.choice_net_dev_groupBox = QGroupBox(self.modbus_dev_tab)
        self.choice_net_dev_groupBox.setObjectName(u"choice_net_dev_groupBox")
        self.choice_net_dev_groupBox.setGeometry(QRect(950, 10, 299, 121))
        self.out_net_dev_listWidget = QListWidget(self.choice_net_dev_groupBox)
        self.out_net_dev_listWidget.setObjectName(u"out_net_dev_listWidget")
        self.out_net_dev_listWidget.setGeometry(QRect(10, 20, 281, 91))
        self.input_state_dev_groupBox = QGroupBox(self.modbus_dev_tab)
        self.input_state_dev_groupBox.setObjectName(u"input_state_dev_groupBox")
        self.input_state_dev_groupBox.setGeometry(QRect(510, 9, 341, 121))
        self.b1_state_lcdNumber = QLCDNumber(self.input_state_dev_groupBox)
        self.b1_state_lcdNumber.setObjectName(u"b1_state_lcdNumber")
        self.b1_state_lcdNumber.setGeometry(QRect(10, 90, 41, 23))
        self.executive1_label = QLabel(self.input_state_dev_groupBox)
        self.executive1_label.setObjectName(u"executive1_label")
        self.executive1_label.setGeometry(QRect(20, 30, 47, 14))
        self.executive2_label = QLabel(self.input_state_dev_groupBox)
        self.executive2_label.setObjectName(u"executive2_label")
        self.executive2_label.setGeometry(QRect(80, 30, 47, 14))
        self.b2_state_lcdNumber = QLCDNumber(self.input_state_dev_groupBox)
        self.b2_state_lcdNumber.setObjectName(u"b2_state_lcdNumber")
        self.b2_state_lcdNumber.setGeometry(QRect(70, 90, 41, 23))
        self.b3_state_lcdNumber = QLCDNumber(self.input_state_dev_groupBox)
        self.b3_state_lcdNumber.setObjectName(u"b3_state_lcdNumber")
        self.b3_state_lcdNumber.setGeometry(QRect(130, 90, 41, 23))
        self.b4_state_lcdNumber = QLCDNumber(self.input_state_dev_groupBox)
        self.b4_state_lcdNumber.setObjectName(u"b4_state_lcdNumber")
        self.b4_state_lcdNumber.setGeometry(QRect(190, 90, 41, 23))
        self.view_devs_pushButton = QPushButton(self.modbus_dev_tab)
        self.view_devs_pushButton.setObjectName(u"view_devs_pushButton")
        self.view_devs_pushButton.setGeometry(QRect(870, 30, 75, 41))
        self.tabWidget.addTab(self.modbus_dev_tab, "")
        ...
        self.states_groupBox = QGroupBox(self.main_tab)
        self.states_groupBox.setObjectName(u"states_groupBox")
        sizePolicy1 = QSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Fixed)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.states_groupBox.sizePolicy().hasHeightForWidth())
        self.states_groupBox.setSizePolicy(sizePolicy1)
        self.states_groupBox.setMinimumSize(QSize(371, 120))
        self.states_groupBox.setStyleSheet(u"")

        self.horizontalLayout_2.addWidget(self.states_groupBox)
        ...
        self.sensor10_lbl = QLabel(self.main_tab)
        self.sensor10_lbl.setObjectName(u"sensor10_lbl")

        self.gridLayout.addWidget(self.sensor10_lbl, 0, 9, 1, 1)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.chenge_state_device_groupBox.setTitle(QCoreApplication.translate("MainWindow", u"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0435 \u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0430", None))
        self.choice_net_dev_groupBox.setTitle(QCoreApplication.translate("MainWindow", u"\u0421\u0435\u0442\u0435\u0432\u043e\u0439 \u043a\u043e\u043d\u0442\u0440\u043e\u043b\u043b\u0435\u0440", None))
        self.input_state_dev_groupBox.setTitle(QCoreApplication.translate("MainWindow", u"\u041f\u043e\u043b\u0443\u0447\u0435\u043d\u043d\u043e\u0435 \u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u0435 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0430 (hex)", None))
        self.executive1_label.setText(QCoreApplication.translate("MainWindow", u"\u0418\u0423 1", None))
        self.executive2_label.setText(QCoreApplication.translate("MainWindow", u"\u0418\u0423 2", None))
        self.view_devs_pushButton.setText(QCoreApplication.translate("MainWindow", u"View", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.modbus_dev_tab), QCoreApplication.translate("MainWindow", u"Modbus/\u0410\u0434\u0440\u0435\u0441\u043d\u044b\u0435 \u0443\u0441\u0442\u0440\u043e\u0439\u0441\u0442\u0432\u0430", None))
#if QT_CONFIG(whatsthis)
        self.states_groupBox.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u0414\u043b\u044f \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f \u0434\u0430\u0442\u0447\u0438\u043a\u0430 \u043d\u0443\u0436\u043d\u043e \u0432\u044b\u0431\u0440\u0430\u0442\u044c \u0434\u0430\u0442\u0447\u0438\u043a \u0432 \u0442\u0430\u0431\u043b\u0438\u0446\u0435 \u0438 \u043d\u0430\u0436\u0430\u0442\u044c \u043d\u0430 \u0441\u043e\u043e\u0442\u0432\u0435\u0442\u0441\u0442\u0432\u0443\u044e\u0449\u0443\u044e \u043a\u043d\u043e\u043f\u043a\u0443 \u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f.</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.states_groupBox.setTitle(QCoreApplication.translate("MainWindow", u"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0435 \u0441\u043e\u0441\u0442\u043e\u044f\u043d\u0438\u044f \u0432\u044b\u0431\u0440\u0430\u043d\u043d\u043e\u0433\u043e \u0434\u0430\u0442\u0447\u0438\u043a\u0430.", None))
...
"\n"
"58", None))
        self.sensor62_lbl.setText(QCoreApplication.translate("MainWindow", u"\u0418\u0421\u041c-22\n"
"\n"
"62", None))
...
"\n"
"1", None))
        self.sensor9_lbl.setText(QCoreApplication.translate("MainWindow", u"NLS16\n"
"\n"
"9", None))
...
"\n"
"57", None))
        self.sensor10_lbl.setText(QCoreApplication.translate("MainWindow", u"NLS8\n"
"\n"
"10", None))
